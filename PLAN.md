...
5. Phase 6 follow-through: watch marketplace issue #4566 for the bot's validation and the security baseline and fix anything it names; answer discussion #9936; pick which of the six upstream issue texts in `outbound/upstream-candidates.md` go, and where.
